...
public class PermissionHelper implements DialogInterface.OnDismissListener
{
    ...
    {
        "Please accept the Bluetooth/Location permission",
        "Please accept the Storage reading permission",
        "The Bluetooth/Location permission is denied",
    ...
    {
        (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) ? Manifest.permission.BLUETOOTH_SCAN : Manifest.permission.ACCESS_COARSE_LOCATION,
